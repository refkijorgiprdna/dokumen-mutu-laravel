...
@section('title')
    <title>Admin | Tambah Dokumen Mutu</title>
@endsection
            ...
            <form action="{{ route('dokumen-mutu.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="link" id="link" class="form-control @error('link') is-invalid  @enderror" placeholder="Tambahkan Link" value="{{ old('link') }}">
                        </div>
                    </div>
